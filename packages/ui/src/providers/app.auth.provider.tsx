...
import { SideBarDataType } from '@repo/ui/components/sidebar/sidebar';
import { SideBarData } from '@repo/ui/components/sidebar/sidebar-data';
...
export const AuthProviderContext = createContext<AppAuthProviderType | null>(
  null,
);
